...
public abstract class CodeSourceInitializer {
    ...
    public static final Registry<CodeSourceInitializer> initializers = new DefaultRegistry<>();
    public static final Storage2<Identifier, CodeSourceInitializer> Default_INITIALIZER;

    static {
        Default_INITIALIZER = initializers.registerStorage(new Identifier("Default_initializer"), new CodeSourceInitializer() {
            @Override
